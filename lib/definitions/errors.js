...
Your configuration for the \`podPushArgs\` option is \`${podPushArgs}\`.`,
  ...
  ELINTFAILED: () => ({
    message: 'pod lint failed',
    details: `Running \`pod lib lint\` failed. Verify that \`pod lib lint\` is successful locally before attempting to publish. It could indicate that there is a problem building your cocoapod.`,
  }),
};
